...
<h1 align="center">Keyence Technical Assesment</h3>
<h2 align="center">Rodríguez Agiss Zuriel Uzai</h3>

  <p align="center">
    Base project in HTML, CSS, JS (Vainilla) and Bootstrap to manage and display data stored in LocalStorage
    <br />
...
1. Clone the repo
   ```sh
   git clone https://github.com/nowhereknight/localstorage-test
   ```
2. Open the `index.html` file in your file browser
...
Project Link: [https://github.com/nowhereknight/localstorage-test](https://github.com/nowhereknight/localstorage-test)
